...
// <div class="embed-responsive embed-responsive-16by9 additionalByScript streamModeThing">
// <iframe
//   src=${filmURL}
//   referrerpolicy="origin"
//   scrolling="no"
//   class="streamModeThing"
//   allowfullscreen>
// </iframe>
// </div>`);
//   $("#ytapiplayer").hide();
...
//   $("#rightcontrols").hide();
//   setFilmName();
//   //$(".streamModeThing").css("padding-bottom", "60.25%");
// } else {
//   $(".streamModeThing").remove();
//   $("#ytapiplayer").show();
//   $("#playlistrow").show();
//   $("#rightpane").show();
//   $("#rightcontrols").show();
